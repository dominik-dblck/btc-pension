                ...
                <div className="w-full" style={{ height: portfolioHeight }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={simWithRef}>
                      ...
                      <Line type="monotone" dataKey="realNetWorth" strokeWidth={1} strokeOpacity={0.7} name="Real Net Worth (no refs) (€)" />
                      <Line type="monotone" dataKey="realNetWorthWithRef" strokeWidth={1} strokeOpacity={0.7} strokeDasharray="1 1" name="Real Net Worth + Referrals (€)" />
                  ...
                  <div className="w-full h-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={simWithRef}>
                        ...
                        <Line type="monotone" dataKey="realNetWorth" strokeWidth={1} strokeOpacity={0.7} name="Real Net Worth (no refs) (€)" />
                        <Line type="monotone" dataKey="realNetWorthWithRef" strokeWidth={1} strokeOpacity={0.7} strokeDasharray="1 1" name="Real Net Worth + Referrals (€)" />
                        {carM !== null && <ReferenceLine x={carM} strokeDasharray="3 3" label={<span><div style={{fontSize: "1.2em"}}>🚗</div>Car</span>} />}
                        {houseM !== null && <ReferenceLine x={houseM} strokeDasharray="3 3" label={<span><div style={{fontSize: "1.2em"}}>🏠</div>House</span>} />}
                        {tuitionM !== null && <ReferenceLine x={tuitionM} strokeDasharray="3 3" label={<span><div style={{fontSize: "1.2em"}}>🎓</div>Tuition</span>} />}
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </div>
