            ...
            <Card className="bg-slate-800/60 backdrop-blur rounded-2xl border border-slate-700 shadow-lg">
              ...
              <CardContent className="px-6 pb-8 space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  {([
                    ["monthlyContribution", "Monthly Contribution (EUR)", 1, 1, "Miesięczna wpłata w EUR, kupujemy BTC po cenie z danego miesiąca"],
                    ["initialPrice", "Initial BTC Price (EUR)", 1, 1, "Cena startowa BTC w EUR"],
                    ["cagr", "BTC CAGR (%)", 0.1, 100, "Roczna stopa wzrostu BTC w idealnym scenariuszu (bez zmienności)"],
                    ["years", "Horizon (yrs)", 1, 1, "Horyzont oszczędzania w latach"],
                    ["ltv", "Max/Target LTV (%)", 0.1, 100, "Docelowy/maksymalny LTV używany do liczenia pojemności długu"],
                    ["loanRate", "Loan Interest (APR, %)", 0.1, 100, "Roczna stopa procentowa pożyczki"],
                    ["yieldRate", "Yield Rate (APY, %)", 0.1, 100, "Roczna stopa zwrotu z ulokowanego kapitału (na długu)"],
