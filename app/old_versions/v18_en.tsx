              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
                  ...
                  <li>
                    ...
                    P&amp;L increments of referred users increases your balance
                    (parameters: count and average deposit).
                  </li>
                  <li>
            ...
            <CardContent className="px-6 pb-8 space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  <LabelWithInfo
                    text="Fee (%)"
                    tip="Percentage of participant's positive P&amp;L (high‑water mark) collected by the platform."
                  />
                  <Input
                    type="number"
                    min={0}
              ...
              <p className="text-xs text-gray-400 pt-1">
                Chart: <em>Total (€/year)</em>, <em>Avg per user (€/year)</em>{' '}
                and <em>Users</em> (right axis). Cohort view (users join over
                time).
              </p>
              <div className="h-[380px] w-full">
                <ResponsiveContainer width="100%" height="100%">
