...
const BTC_PensionCalculator: React.FC = () => {
  ...
  const carM = useMemo(
    () => firstAffordableMonthWithRef(sim, carCost, inp.ltv, refFeeByMonth),
    [sim, carCost, inp.ltv, refFeeByMonth]
  );
  const houseM = useMemo(
    () => firstAffordableMonthWithRef(sim, houseCost, inp.ltv, refFeeByMonth),
    [sim, houseCost, inp.ltv, refFeeByMonth]
  );
  const tuitionM = useMemo(
    () => firstAffordableMonthWithRef(sim, tuitionCost, inp.ltv, refFeeByMonth),
    [sim, tuitionCost, inp.ltv, refFeeByMonth]
  );
        ...
        >
          ...
          <header className="text-center space-y-4">
            ...
            <p className="text-sm md:text-base text-gray-300 max-w-3xl mx-auto">
              ...
              Progi dla dużych wydatków (samochód / dom / studia) liczone z
              dostępnej pojemności długu.
            </p>
            <p className="text-xs md:text-sm text-gray-400 max-w-3xl mx-auto">
              Pola % wpisuj jako wartości <em>w procentach</em>; model przelicza
              je na ułamki.
            </p>
          </header>
            ...
            <CardContent className="px-6 pb-8 space-y-6 text-sm">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
                  <li>
                    <strong>Akumulacja</strong>: miesięczne DCA w EUR; cena BTC
                    rośnie wg stałego CAGR {(inp.cagr * 100).toFixed(1)}% (bez
                    zmienności).
                  </li>
                  <li>
                    <strong>Zabezpieczenie</strong>: pojemność długu ={' '}
                    <em>LTV × wartość BTC − saldo długu</em>. Zakupy
                    (auto/dom/studia) możliwe, gdy pojemność ≥ koszt.
                  </li>
                  <li>
                    <strong>Rebalans</strong>: kwartalnie do docelowego LTV{' '}
                    {(inp.ltv * 100).toFixed(0)}%. <em>Auto‑draw</em>{' '}
                    {autoDrawToTarget ? 'ON' : 'OFF'} — ON: wykorzystuje
                    pojemność na bieżąco; OFF: czekamy do zakupu.
                  </li>
                  <li>
                    <strong>Referrals</strong>: przyrost <em>pozytywnego</em>{' '}
                    P&L poleconych zasila Twoją emeryturę jako 1% fee (parametry
                    ich wpłat: liczba i średnia miesięczna kwota). **Teraz
                    wliczane także do progów zakupu**.
                  </li>
                  <li>
                    <strong>Finansowanie</strong>: odsetki APR{' '}
                    {(inp.loanRate * 100).toFixed(1)}% i yield APY{' '}
                    {(inp.yieldRate * 100).toFixed(1)}% naliczane miesięcznie od
                    salda długu.
                  </li>
                  <li>
                    <strong>Wynik</strong>: pokazujemy Net Worth (bez/referrals)
                    i P&L vs. wpłaty; opłaty 1% platforma + 1% referrer od{' '}
                    <em>pozytywnego</em> P&L.
                  </li>
                </ul>
              </div>
              {(spreadWarn || ltvWarn) && (
                <div className="text-xs text-amber-300">
                  {spreadWarn && (
                    <p>
                      Uwaga: Spread ≤ 0 (yield ≤ interest). W idealnych
                      warunkach przychód ze spreadu nie pokryje kosztu długu.
                    </p>
                  )}
                  {ltvWarn && (
                    <p>
          ...
          <section className="grid lg:grid-cols-2 gap-10 items-start">
            ...
            >
              ...
              <CardContent className="px-6 pb-8 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <LabelWithInfo
                        ...
                        tip="Miesięczna wpłata w EUR, kupujemy BTC po cenie z danego miesiąca"
                      />
                      <Input
                        type="number"
                        min={0}
                    ...
                    <div className="space-y-1">
                      <LabelWithInfo
                        text="BTC CAGR (%)"
                        tip="Roczna stopa wzrostu BTC w idealnym scenariuszu (bez zmienności)"
                      />
                      <Input
                        type="number"
                        min={0}
                    ...
                    <div className="space-y-1">
                      <LabelWithInfo
                        text="Horizon (yrs)"
                        tip="Horyzont oszczędzania w latach"
                      />
                      <Input
                        type="number"
                        min={1}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-1">
                      <LabelWithInfo
                        text="Max/Target LTV (%)"
                        tip="Docelowy/maksymalny LTV używany do liczenia pojemności długu"
                      />
                      <Input
                        type="number"
                        min={0}
                    ...
                    <div className="space-y-1">
                      <LabelWithInfo
                        ...
                        tip="Roczna stopa procentowa pożyczki"
                      />
                      <Input
                        type="number"
                        min={0}
                    ...
                    <div className="space-y-1">
                      <LabelWithInfo
                        text="Yield Rate (APY, %)"
                        tip="Roczna stopa zwrotu z ulokowanego kapitału (na długu)"
                      />
                      <Input
                        type="number"
                        min={0}
                  ...
                  <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <LabelWithInfo
                        ...
                        tip="Automatyczne dociąganie salda długu do docelowego LTV na koniec kwartału. Gdy OFF — pojemność długu rośnie do czasu zakupu."
                      />
                      <Button
                        type="button"
                ...
                <div>
                  <h4 className="text-sm font-semibold text-slate-200 mb-2">
                    Używanie kapitału (dom / szkoła / samochód)
                  </h4>
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="space-y-1">
                      <LabelWithInfo
                        text="Car Cost (EUR)"
                        tip="Budżet na samochód finansowany kredytem pod zastaw zgromadzonego BTC."
                      />
                      <Input
                        type="number"
                        min={0}
                    ...
                    <div className="space-y-1">
                      <LabelWithInfo
                        text="House Cost (EUR)"
                        tip="Budżet na dom/mieszkanie; model sprawdza, kiedy pojemność długu osiągnie ten koszt przy danym LTV."
                      />
                      <Input
                        type="number"
                        min={0}
                    ...
                    <div className="space-y-1">
                      <LabelWithInfo
                        ...
                        tip="Łączny koszt studiów dzieci; moment, gdy można go sfinansować kredytem pod zastaw BTC."
                      />
                      <Input
                        type="number"
                        min={0}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <LabelWithInfo
                        ...
                        tip="Liczba bezpośrednich poleconych użytkowników, którzy oszczędzają wg tych samych parametrów (poza swoją miesięczną wpłatą)."
                      />
                      <Input
                        type="number"
                        min={0}
                    ...
                    <div className="space-y-1">
                      <LabelWithInfo
                        ...
                        tip="Średnia miesięczna wpłata jednego poleconego — wpływa na 1% fee doliczane do Twojego portfela."
                      />
                      <Input
                        type="number"
                        min={0}
            ...
            <Card
              className="bg-slate-800/60 backdrop-blur rounded-2xl border border-slate-700 shadow-lg relative flex flex-col"
            ...
            >
              ...
              <CardContent className="px-6 pb-8 space-y-3 flex-1 flex flex-col">
                <p className="text-xs text-gray-400">
                  BTC value, loan & net worth over {inp.years} yrs + purchase
                  thresholds + referral uplift
                </p>
          ...
          <Card className="bg-slate-800/60 backdrop-blur rounded-2xl border border-slate-700 shadow-lg">
            ...
            <CardContent className="px-6 pb-8 space-y-3">
              <p className="text-xs text-gray-400">
                1% fee po {inp.years} latach — steruj <em>Users — Count</em> i{' '}
                <em>Users — Avg Monthly</em> niezależnie.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <LabelWithInfo
                    text="Users — Count"
                    tip="Łączna liczba aktywnych użytkowników po horyzoncie."
                  />
                  <Input
                    type="number"
                    min={0}
                ...
                <div className="space-y-1">
                  <LabelWithInfo
                    ...
                    tip="Średnia miesięczna wpłata przypadająca na jednego użytkownika platformy (do wyliczania P&L/fee per user)."
                  />
                  <Input
                    type="number"
                    min={0}
          ...
          <Card className="bg-slate-800/60 backdrop-blur rounded-2xl border border-slate-700 shadow-lg">
            ...
            <CardContent className="px-6 pb-8 space-y-3">
              <p className="text-xs text-gray-400">
                1% udział po {inp.years} latach — steruj{' '}
                <em>Referrals — Count</em> i <em>Referrals — Avg Monthly</em>{' '}
                niezależnie dla tego wykresu.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <LabelWithInfo
                    text="Referrals — Count (chart)"
                    tip="Liczba bezpośrednich poleconych używana wyłącznie do wykresu przychodów referenta."
                  />
                  <Input
                    type="number"
                    min={0}
                ...
                <div className="space-y-1">
                  <LabelWithInfo
                    ...
                    tip="Średnia miesięczna wpłata jednego poleconego używana do obliczeń na wykresie przychodów referenta."
                  />
                  <Input
                    type="number"
                    min={0}
...
function runSelfCheck() {
  ...
  console.assert(
    firstAffordableMonthWithRef(s, 1e6, base.ltv, feesMap) === 0,
