              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
                  ...
                  <li>
                    ...
                    P&amp;L increments of referred users (used only for
                    "Referrer Earnings").
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Platform fee (yield-only)</strong>: platform charges{' '}
                    {platformFeePct}% exclusively from <em>gross yield</em> on
                    deployed capital (loan). No fees from BTC price / P&amp;L.
                  </li>
                </ul>
              </div>
              {(spreadWarn || ltvWarn) && (
          ...
          <Card className="bg-slate-800/60 backdrop-blur rounded-2xl border border-slate-700 shadow-lg">
            ...
            <CardContent className="px-6 pb-8 space-y-3">
              ...
              <p className="text-xs text-gray-400 pt-1">
                ...
                and <em>Users</em> (right axis). Fees calculated exclusively
                from yield (earn) — cohort convolution (users join over time).
              </p>
