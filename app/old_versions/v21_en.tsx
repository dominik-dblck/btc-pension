              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
                  ...
                  <li>
                    ...
                    exchange fee {exchangeFeePct}% from <em>BTC value</em>{' '}
                    (monthly) + {exchangeFeePct}% fee when exchanging EUR to
                    BTC. No fees from BTC price growth / P&amp;L.
                  </li>
                </ul>
              </div>
              {(spreadWarn || ltvWarn) && (
          ...
          <Card className="bg-slate-800/60 backdrop-blur rounded-2xl border border-slate-700 shadow-lg">
            ...
            <CardContent className="px-6 pb-8 space-y-3">
              ...
              <p className="text-xs text-gray-400 pt-1">
                ...
                (earn) + BTC value — cohort convolution (users join over time).
              </p>
