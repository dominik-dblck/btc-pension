      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black text-gray-100">
        ...
        >
          ...
          <header className="text-center space-y-4">
            ...
            {/* moved global percent hint below header */}
          ...
          {/* Parameters (subheader under header) */}
          <Card className="bg-slate-800/60 backdrop-blur rounded-2xl border border-slate-700 shadow-lg">
            ...
            <CardContent className="px-6 pb-8 space-y-6">
              <p className="text-xs text-gray-400 -mt-2">
                Konfiguracja modelu i progów zakupu. Wartości % wpisuj w
                procentach.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-2 pt-4 text-xs text-gray-300">
                <span>
