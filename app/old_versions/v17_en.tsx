      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black text-gray-100">
        ...
        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <LabelWithInfo
                    ...
                    tip="Liczba użytkowników w pierwszym roku (np. 50 000)."
                  />
                  <Input
                    type="number"
                    min={0}
                ...
                <div className="space-y-1">
                  <LabelWithInfo
                    ...
                    tip="Docelowa liczba użytkowników w ostatnim roku horyzontu (np. 1 000 000)."
                  />
                  <Input
                    type="number"
                    min={0}
                ...
                <div className="space-y-1">
                  <LabelWithInfo
                    text="Growth Mode"
                    tip="Model wzrostu liczby użytkowników: liniowy lub CAGR (wykładniczy) pomiędzy wartościami Start i End."
                  />
                  <Button
                    type="button"
          ...
          <Card className="bg-slate-800/60 backdrop-blur rounded-2xl border border-slate-700 shadow-lg">
            <CardHeader className="px-6 pt-6 pb-3">
              <CardTitle className="text-lg text-white">
                Platform Earnings — Over Time (Annual, user growth)
              </CardTitle>
            </CardHeader>
            <CardContent className="px-6 pb-8 space-y-3">
              <p className="text-xs text-gray-400">
                Roczne przychody z fee od dodatnich przyrostów P&amp;L
                (high‑water mark). Linie: <em>Per user</em>, <em>Total</em>{' '}
                (zależny od liczby użytkowników w danym roku) oraz{' '}
                <em>Users</em> (oś prawa). Zakres użytkowników:{' '}
                <strong>{fmt(usersStart)}</strong> →{' '}
                <strong>{fmt(usersEnd)}</strong> (
                {usersGrowthMode.toUpperCase()}), Fee:{' '}
