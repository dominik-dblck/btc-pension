      ...
      >
        ...
        <header className="text-center space-y-4">
          ...
          <p className="text-sm md:text-base text-gray-300 max-w-3xl mx-auto">
            ...
            Dodano progi (thresholds) na duże wydatki finansowane kredytem pod
            zastaw BTC.
          </p>
        </header>
          ...
          <CardContent className="px-6 pb-8 space-y-6 text-sm">
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1 text-gray-300">
                ...
                <li>
                  Docelowy/maksymalny LTV {(inp.ltv * 100).toFixed(0)}%,
                  pożyczka APR {(inp.loanRate * 100).toFixed(1)}%, yield APY{' '}
                  {(inp.yieldRate * 100).toFixed(1)}%.
                </li>
                <li>
                  Rebalans kwartalny. <strong>Auto‑draw do LTV</strong>:{' '}
                  {autoDrawToTarget
                    ? 'ON (wykorzystuj pojemność długu na bieżąco)'
                    : 'OFF (zaciągamy dług tylko przy zakupach)'}
                  .
                </li>
                <li>
            ...
            <CardContent className="px-6 pb-8 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="space-y-1">
                  <label
                    className="text-xs font-semibold text-gray-300"
                    title="Auto‑draw do docelowego LTV na koniec kwartału"
                  >
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                ...
                <div className="space-y-1">
                  <label
                    className="text-xs font-semibold text-gray-300"
                    title="Łączny koszt studiów dzieci (EUR)"
                  >
                    Tuition Cost (EUR)
                  </label>
                  <Input
            ...
            <CardContent className="px-6 pb-8 h-80">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={sim}>
                  ...
                  />
                  {carM !== null && (
                    <ReferenceLine x={carM} strokeDasharray="3 3" label="Car" />
                  )}
                  {houseM !== null && (
                    <ReferenceLine
                      x={houseM}
