    ...
    >
      ...
      <Card className="w-full xl:col-span-3 lg:col-span-2">
        <CardHeader>
          ...
          <CardDescription>
            Dollar‑cost‑averages monthly fiat into BTC, leverages{' '}
            <strong>{inp.ltv * 100}%</strong> of the growing BTC value at{' '}
            <strong>{(inp.loanRate * 100).toFixed(1)}% APR</strong>, and
            redeploys that capital at{' '}
            <strong>{(inp.yieldRate * 100).toFixed(1)}% APY</strong>. Simulation
            horizon:
            <strong> {inp.years} years</strong>. Platform and referrer each
            collect a 1% performance fee on realised user profit.
          </CardDescription>
        </CardHeader>
        <CardContent className="text-sm space-y-1">
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              Monthly contribution starts at €{fmt(inp.monthlyContribution)} and
              buys fewer BTC over time as price rises with a{' '}
              {fmt(inp.cagr * 100, 1)}% CAGR.
            </li>
            <li>
              Loan‑to‑value is fixed at {fmt(inp.ltv * 100, 0)}%; margin call
              threshold not modelled.
            </li>
            <li>
              Yield and interest are compounded monthly; no tax/friction costs
              included.
            </li>
      ...
      <Card className="w-full lg:col-span-1">
        ...
        <CardContent className="space-y-4">
            ...
            {(
              ...
              <div key={k} className="space-y-1">
                ...
                <Input
                  ...
                  onChange={e =>
                    updateInp(k, String(Number(e.target.value) / mult))
                  }
                />
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
            ...
            <p>
              <strong>User cumulative profit:</strong> €
              {fmt(last.cumulativeCashFlow)}
            </p>
            <p>
              <strong>Platform fee / user:</strong> €{feePU.toFixed(2)}
            </p>
            <p>
              <strong>Referrer fee / user:</strong> €{feePU.toFixed(2)}
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="w-full lg:col-span-1">
        <CardHeader>
          ...
          <CardDescription>
            BTC value, loan balance, and cumulative cash‑flow over time
          </CardDescription>
        </CardHeader>
      ...
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>
            Total fee (€) collected after {inp.years} years vs user count
          </CardDescription>
        </CardHeader>
      ...
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>
            Passive income (€) after {inp.years} years vs referrals
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3 h-96">
          <div>
