      ...
      >
        ...
        <header className="text-center space-y-4">
          ...
          <p className="text-sm md:text-base text-gray-300 max-w-3xl mx-auto">
            Deterministyczny model DCA → LTV‑loan → yield pod idealne warunki. Opłaty: 1% platforma & 1% referrer od <em>pozytywnego</em> P&amp;L netto użytkownika. Wartości przed podatkiem.
          </p>
        </header>
          ...
          <CardContent className="px-6 pb-8 space-y-6 text-sm">
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1 text-gray-300">
                ...
                <li>Cel LTV {(inp.ltv * 100).toFixed(0)}%, pożyczka APR {(inp.loanRate * 100).toFixed(1)}%, yield APY {(inp.yieldRate * 100).toFixed(1)}%.</li>
                <li>Rebalans do docelowego LTV na koniec każdego kwartału; odsetki i yield naliczane miesięcznie.</li>
