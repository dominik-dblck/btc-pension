            ...
            <CardContent className="px-6 pb-8 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input type="number" min={0} value={maxUsers} onChange={(e) => setMaxUsers(Number(e.target.value))} className="rounded-lg bg-slate-900/70 border-slate-700 text-xs" />
                </div>
                <div className="space-y-1">
                  ...
                  <Input type="number" min={0} value={platformAvgMonthly} onChange={(e) => setPlatformAvgMonthly(Number(e.target.value))} className="rounded-lg bg-slate-900/70 border-slate-700 text-xs" />
                </div>
              </div>
            ...
            <CardContent className="px-6 pb-8 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input type="number" min={0} value={maxRefs} onChange={(e) => setMaxRefs(Number(e.target.value))} className="rounded-lg bg-slate-900/70 border-slate-700 text-xs" />
                </div>
                <div className="space-y-1">
                  ...
                  <Input type="number" min={0} value={refChartAvgMonthly} onChange={(e) => setRefChartAvgMonthly(Number(e.target.value))} className="rounded-lg bg-slate-900/70 border-slate-700 text-xs" />
                </div>
              </div>
              <div className="h-[380px] w-full">
                <ResponsiveContainer width="100%" height="100%">
